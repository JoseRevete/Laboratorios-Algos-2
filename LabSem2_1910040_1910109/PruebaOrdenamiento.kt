...
*/
fun algoritmoAEjecutar(array : Array<Number>, tnum: Int, algoritmo: String, num : Int, arrayTP: Array<Double>, i: Int, arrayTMin : Array<Double>, arrayTMax : Array<Double>) : Triple<Array<Double>, Array<Double>, Array<Double>> {
